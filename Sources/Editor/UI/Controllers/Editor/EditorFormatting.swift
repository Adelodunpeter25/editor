...
extension EditorViewController {
  ...
  func applyFormat(_ outcome: Formatter.Outcome, expecting original: String) {
    ...
    guard textView.text == original else { return }
    switch outcome {
  ...
  func replacePreservingCursor(with newText: String) {
    ...
    guard textView.replaceCharacters(inRange: replaceRange, with: replacement) else { return }
