...
final class EditorViewController: NSViewController, NSTextViewDelegate, SourceEditing {
    ...
    private static let highlightQueue = DispatchQueue(label: "com.editor.highlight", qos: .userInitiated)
    ...
    private static let formatQueue = DispatchQueue(label: "com.editor.format", qos: .userInitiated)
    ...
    private func mono(_ s: Double) -> NSFont { AppFont.mono(size: s) }
