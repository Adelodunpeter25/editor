...
enum FormatterPrompt {
    ...
    static func notInstalled(_ spec: FormatterSpec) {
        ...
        alert.informativeText = "Editor will run this in a new Terminal tab so you can watch it:\n\n\(command)"
    ...
    static func noFormatter(ext: String) {
        ...
        alert.informativeText = "Editor doesn’t have a formatter mapped to this file type yet."
