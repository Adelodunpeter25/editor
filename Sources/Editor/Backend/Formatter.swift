...
enum Formatter {
  static let specs: [FormatterSpec] = [
    ...
    FormatterSpec(
      id: "swift-format", name: "swift-format", exts: ["swift"], binaries: ["swift-format"],
  ...
  static func isInstalled(
    _ spec: FormatterSpec, near dir: String = FileManager.default.currentDirectoryPath
  ) -> Bool {
  ...
  private static func runPipe(_ argv: [String], cwd: String, stdin: String) -> (
