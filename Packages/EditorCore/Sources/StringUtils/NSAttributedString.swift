...
extension NSAttributedString {
  ...
  public final var mutable: NSMutableAttributedString {
  ...
  public final func enumerateAttribute<T>(
    _ attrName: NSAttributedString.Key, type: T.Type, in enumerationRange: NSRange,
    options: EnumerationOptions = [],
    using block: (_ value: T, _ range: NSRange, _ stop: UnsafeMutablePointer<ObjCBool>) -> Void
  ) {

    self.enumerateAttribute(attrName, in: enumerationRange, options: options) {
      value, range, stop in
  ...
  public func longestEffectiveRange(of attrName: NSAttributedString.Key, at index: Int) -> NSRange?
  {

    var effectiveRange = NSRange.notFound

    guard
      self.attribute(attrName, at: index, longestEffectiveRange: &effectiveRange, in: self.range)
        != nil
    else { return nil }
  ...
  public final func hasAttribute(_ attrName: NSAttributedString.Key, in range: NSRange? = nil)
    -> Bool
  {
    ...
    guard range.upperBound <= self.length else {
      assertionFailure()
      return false
    }
    ...
    let value = self.attribute(
      attrName, at: range.location, longestEffectiveRange: &effectiveRange, in: range)
  ...
  public final func truncatedHead(until location: Int, offset: Int) -> NSAttributedString {
...
extension NSMutableAttributedString {
  ...
  ///   - location: The character index at which truncation should start.
  ///   - offset: The maximum number of composed characters to leave to the left of `location`.
  public final func truncateHead(until location: Int, offset: Int) {
...
extension Sequence<NSAttributedString> {
  ...
  public func joined(separator: Element? = nil) -> Element {
