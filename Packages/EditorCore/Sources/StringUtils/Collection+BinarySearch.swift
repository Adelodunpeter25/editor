...
extension RandomAccessCollection {
  ...
  public func partitioningIndex(in range: Range<Index>? = nil, predicate: (Element) throws -> Bool)
    throws -> Index
  {
    ...
    while lowerBound < upperBound {
      let middleIndex = self.index(
        lowerBound, offsetBy: self.distance(from: lowerBound, to: upperBound) / 2)
