...
extension Syntax.Indentation {
  ...
  mutating func sanitize() {
    ...
    for index in self.blockDelimiters.indices where self.blockDelimiters[index].end?.isEmpty == true
    {
...
extension MutableCollection where Self: RandomAccessCollection {
  ...
  fileprivate mutating func caseInsensitiveSort(_ keyPath: KeyPath<Element, String>) {
