...
public struct Syntax: Equatable, Sendable {
  ...
  public struct FileMap: Equatable, Sendable, Codable {
    ...
    public init(
      extensions: [String]? = nil, filenames: [String]? = nil, interpreters: [String]? = nil
    ) {
  ...
  public struct Highlight: Equatable, Sendable {
    ...
    public init(
      begin: String = "", end: String? = nil, isRegularExpression: Bool = false,
      ignoreCase: Bool = false, isMultiline: Bool = false, description: String? = nil
    ) {
  ...
  public struct Outline: Equatable, Sendable {
    ...
    public init(
      pattern: String = "", template: String = "", ignoreCase: Bool = false, kind: Kind? = nil,
  ...
  public struct PairDelimiter: Equatable, Sendable {
    ...
    public init(
      begin: String = "", end: String = "", prefixes: [String]? = nil, isMultiline: Bool = false,
      escapeCharacter: Character? = nil, description: String? = nil
    ) {
  ...
  public struct Delimiter: Equatable, Sendable {
    ...
    public init(
      begin: String = "", end: String? = nil, ignoreCase: Bool = false, description: String? = nil
    ) {
  ...
  public struct Metadata: Equatable, Sendable, Codable {
    ...
    public init(
      version: String? = nil, lastModified: String? = nil, distributionURL: String? = nil,
      author: String? = nil, license: String? = nil, description: String? = nil
    ) {
