...
public struct OutlineItem: Hashable, Equatable, Sendable, Identifiable {
  ...
  public init(
    title: String, range: NSRange, kind: Syntax.Outline.Kind? = nil, indent: Indent = .level(0),
    id: UUID = UUID()
  ) {
  ...
  public static func separator(range: NSRange, indent: Indent = .level(0), id: UUID = UUID())
    -> Self
  {
