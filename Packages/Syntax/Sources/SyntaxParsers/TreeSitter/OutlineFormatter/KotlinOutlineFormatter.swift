...
enum KotlinOutlineFormatter: TreeSitterOutlineFormatting {
...
private extension KotlinOutlineFormatter {
    
    /// Builds the displayed Kotlin function title from a query match.
    ///
    /// - Parameters:
    ...
    /// Returns the signature range spanning the Kotlin function name through its parameter list.
    ///
    /// - Parameters:
    ///   - match: The resolved query match.
    ...
    /// Returns a whitespace-normalized Kotlin parameter clause.
    ///
