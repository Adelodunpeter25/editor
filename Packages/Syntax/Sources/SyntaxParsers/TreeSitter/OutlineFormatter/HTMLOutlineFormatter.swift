...
extension HTMLOutlineFormatter {
  ...
  fileprivate static func textRanges(in node: Node) -> [NSRange] {
  ...
  fileprivate static func titleText(from ranges: [NSRange], source: NSString) -> String {
  ...
  fileprivate static func containsVisibleWhitespace(in string: String) -> Bool {
